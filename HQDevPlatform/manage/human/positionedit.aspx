<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" AutoEventWireup="true" CodeBehind="positionedit.aspx.cs" Inherits="HQDevSys.manage.human.positionedit" %>
    ...
    <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
        <tr>
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <input type="text" id="txtpositionname" value="<%=positionname %>" style="width:350px;" />
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <input type="text" id="txtpositiondept" value="<%=positiondept %>" style="width:350px;" />
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
        ...
        <tr>
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <input type="text" id="txtpositionnum" value="<%=positionnum %>" style="width:100px;" />
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
        ...
        <tr>
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <input type="text" id="txtbackcontent" value="<%=bakcontent %>" style="width:550px;" />
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <textarea id="txtcontent" style="width:99%;height:300px;"><%=content%></textarea>
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                <input type="text" id="txtorder" value="<%=order %>" style="width:100px;" />
            </td>
        </tr>
    </table>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="CPHJavascript" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            var _type = "<%=positiontype %>";
            $("#selpositiontype").val(_type);
            $("#txtbegindate").datebox("setValue","<%=positionbegindate %>");
            $("#txtenddate").datebox("setValue","<%=positionenddate %>");
        });
