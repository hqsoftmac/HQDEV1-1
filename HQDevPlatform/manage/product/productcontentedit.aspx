<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" ValidateRequest= "false" AutoEventWireup="true" CodeBehind="productcontentedit.aspx.cs" Inherits="HQDevSys.manage.product.productcontentedit" %>
            ...
            <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtproductname" value="<%=gsproductname %>" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="hidden" id="hproductlist" value="<%=gsproductlistid %>"/>
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtproductmodule" value="<%=gsproductmodule %>" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtproductdesc" value="<%=gsproductdesc %>" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtbriefpicpath" value="<%=gsbriefpic %>" style="width:550px;" disabled />&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtpicpath" value="<%=gspic %>" style="width:550px;" disabled />&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txtbriefcontent" style="width:98%;height:300px;"><%=gsbriefcontent%></textarea>
                    </td>
                </tr>
            </table>
        </div>
        <div title="详细内容" style="padding:5px;">
            <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txtcontent" style="width:98%;height:420px;"><%=gscontent%></textarea>
                    </td>
                </tr>
            </table>
        </div>
        <div title="SEO信息" style="padding:5px;">
            <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtseotitle" value="<%=gsseotitle %>" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtseokeyword" value="<%=gsseokeyword %>" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txtseodesc" style="width:98%;height:350px;"><%=gsseodesc %></textarea>
                    </td>
                </tr>
            </table>
        </div>
