<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="articlecontentadd.aspx.cs" Inherits="HQDevSys.manage.article.articlecontentadd" %>
            ...
            <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtarticletitle" value="" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txtcontent" style="width:98%;height:400px;"></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div title="附属设定" style="padding:20px;">
            <table style="width:100%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">  
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txttitlestyle" style="width:98%;height:50px;"></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtauthor" value="" style="width:250px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtcomefrom" value="" style="width:250px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txtclicknum" value="0" style="width:150px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <input type="text" id="txturl" value="" style="width:550px;" />
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 120px; background-color: #e1f5fc; height: 25px;" >
                ...
                <tr>
                    ...
                    <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                        <textarea id="txtbriefcontent" rows="10" style="width:98%;height:18px;"></textarea>
                    </td>
                </tr>
            </table>
        </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPHJavascript" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#txtreleasetime").datebox("setValue", ss);
        });
