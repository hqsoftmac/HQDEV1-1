<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" AutoEventWireup="true" CodeBehind="articlelist.aspx.cs" Inherits="HQDevSys.manage.article.articlelist" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPHContent" runat="server">
    <div style="width:100%;margin:0 auto;">
        ...
        <div style="width:98%;margin:0 auto;clear:both;">
            <table id="articlelistgrid" class="easyui-datagrid" title="栏目列表" style="margin:2px auto;" data-options="singleSelect:false,fitColumns:true,idField:'FListId',rownumbers:true,pagination:true">
                <thead>
                    <tr>
                        <th data-options="field:'FListId',align:'center',checkbox:true">选择</th>
                        <th data-options="field:'FListName',width:160,align:'center'">目录名称</th>
                        <th data-options="field:'FListOrder',width:60,align:'center'">顺序</th>
    ...
    <input type="hidden" id="hsortname" value="FListOrder" />
    ...
    <!-- 新增窗口 Begin-->
    <div id="addwin" iconCls="icon-save" title="文章目录资料" style="display:none;text-align:center;">  
        ...
        function editlist(id) {
            var options = {
                ...
                success: function (res) {
                    ...
                    $("#hlistid").val(json.FListId);
                    $("#txtlistname").val(json.FListName);
                    $("#txtlistorder").val(json.FListOrder);
