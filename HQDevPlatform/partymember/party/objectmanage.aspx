<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" AutoEventWireup="true" CodeBehind="objectmanage.aspx.cs" Inherits="HQDevPlatform.partymember.party.objectmanage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHPageTool" runat="server">
    <a href="javascript:void(0)" class="btn" id="btnadd" iconCls="icon-add" onclick="add()">新增发展对象</a>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="CPHContent" runat="server">
            ...
            <table id="listgrid" class="easyui-datagrid" title="列表" style="margin:2px auto;" data-options="singleSelect:false,fitColumns:true,idField:'FMemberId',rownumbers:true,pagination:true">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'FActivistDateStr',width:60,align:'center'">积极份子确定日期</th>
    ...
    <div id="addwin" iconCls="icon-save" title="新增发展对象" style="text-align:center;display:none;">  
		...
		<div style="margin:20px auto;">
            <a href="#" class="btn1" id="btnsave" iconCls="icon-save" onclick="comfirmobject()">确定</a>&nbsp;&nbsp;
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPHJavascript" runat="server">
    <script type="text/javascript">
        ...
        function delobject(id) {
            $.messager.confirm('确认', '您是否确定要取消该人员的发展对象资格吗?取消后，该人员将降级为入党积极份子!', function (r) {
                if (!r) {
                    return;
                }
                else {
