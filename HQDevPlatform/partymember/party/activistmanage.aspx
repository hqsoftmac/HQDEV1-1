<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" AutoEventWireup="true" CodeBehind="activistmanage.aspx.cs" Inherits="HQDevPlatform.partymember.party.activistmanage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHPageTool" runat="server">
    <a href="javascript:void(0)" class="btn" id="btnadd" iconCls="icon-add" onclick="add()">新增积极份子</a>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="CPHContent" runat="server">
            ...
            <table id="listgrid" class="easyui-datagrid" title="列表" style="margin:2px auto;" data-options="singleSelect:false,fitColumns:true,idField:'FMemberId',rownumbers:true,pagination:true">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'FActivistDateStr',width:80,align:'center'">积极份子确定日期</th>
    ...
    <div id="addwin" iconCls="icon-save" title="新增入党积极份子" style="text-align:center;display:none;">  
		...
		<div style="margin:20px auto;">
            <a href="#" class="btn1" id="btnsave" iconCls="icon-save" onclick="comfirmactivist()">确定</a>&nbsp;&nbsp;
...
<asp:Content ID="Content5" ContentPlaceHolderID="CPHJavascript" runat="server">
    <script type="text/javascript">
        ...
        function upobject(id) {
            $.messager.confirm('确认', '您是否确定要将该人员的晋级为发展对象吗?', function (r) {
                if (!r) {
                    return;
                }
                else {
        ...
        function delactivist(id) {
            $.messager.confirm('确认', '您是否确定要取消该人员的入党积极份子吗?', function (r) {
                if (!r) {
                    return;
                }
                else {
        ...
        function comfirmactivist() {
            ...
            common.Ajax("SetActivist", options);
        }
