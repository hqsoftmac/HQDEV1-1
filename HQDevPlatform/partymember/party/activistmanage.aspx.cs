...
{
    public partial class activistmanage : PageBase
    {
        ...
        public void DelItem()
        {
            ...
            biz.UpdateActivist(_id, "0", _date,"",  out ErrInfo);
        ...
        public void UpItem()
        {
            ...
            PmPartymemberBiz biz = new PmPartymemberBiz();
            ErrorEntity ErrInfo = new ErrorEntity();
            biz.UpdateObject(_id, "1", _date, "", out ErrInfo);
            Response.Write(ErrInfo.ToJson());
        }

        public void SetActivist()
        {
            ...
            PmPartymemberBiz biz = new PmPartymemberBiz();
            ErrorEntity ErrInfo = new ErrorEntity();
            biz.UpdateActivist(_memberid, "1", _date, _orgid,out ErrInfo);
            Response.Write(ErrInfo.ToJson());
        }
        ...
        public void GetGridData()
        {
            ...
            string wheresql = "(FActivistFlag = '1') and (FObjectFlag = '0') and (FPrePartyFlag = '0') and (FPartyFlag = '0') and (FHistoryFlag = '0') ";
            string _deptid = Parameters["pdeptid"];
            ...
            {
                lists[i].FOperation = "<a iconCls='icon-remove' class='btn' href='javascript:void(0)' onclick='delactivist(" + lists[i].FMemberId.ToString() + ")'>取消资格</a>";
            }
