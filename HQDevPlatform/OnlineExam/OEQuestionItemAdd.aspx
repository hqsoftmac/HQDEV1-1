<%@ Page Title="" Language="C#" MasterPageFile="~/WebContent.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="OEQuestionItemAdd.aspx.cs" Inherits="HQDevPlatform.OnlineExam.OEQuestionItemAdd" %>
    ...
    <table style="width:99%;margin:0px auto;" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">  
        <tr>
            ...
            <td style="background-color: #ffffff; padding-left:5px;text-align:left;" >
                ...
                <textarea id="txtFItemContent" style="width:99%;height:350px;"></textarea>
            </td>
        </tr>
        <tr>
            <td align="right" style="width: 100px; background-color: #e1f5fc; height: 25px;" >
