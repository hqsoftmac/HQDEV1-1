...
namespace HQPartyManage.ML
{
    //PmOrgInfo
    [Serializable]
    public class PmOrgInfo : IDatasource
    {
        ...
        public string FOperation
        {
            get
            {
                return "<a href=\"javascript:void(0)\" onclick=\"downclass(" + FOrgId.ToString() + ")\">下级党组织</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:void(0)' onclick='edit(" + FOrgId.ToString() + ")'>编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:void(0)' onclick='commeett(" + FOrgId.ToString() + ")'>成员管理</a>";
            }
        }
